      ...
      <section className="pt-80 pb-16 bg-[#000000] w-full">
        <div className="max-w-[1800px] mx-auto px-8 lg:px-16">
          ...
          >
            ...
            >
              Ready to transform your diagnostic workflow? Schedule a personalized demo to see how NXXIM can unify your diagnostic data and accelerate clinical decisions with AI-powered intelligence.
            </p><br></br>
          </motion.div>
        </div>
      </section>
